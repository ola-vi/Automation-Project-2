...
describe("Issue create", () => {
  ...
  it.only("Random Data Plugin Issue Creation (TC2)", () => {
    /*
    Test Case 2: Random Data Plugin Issue Creation:

In the same spec file, “issue-create.cy.js,” add another test case for creating a new issue using the random data plugin.
